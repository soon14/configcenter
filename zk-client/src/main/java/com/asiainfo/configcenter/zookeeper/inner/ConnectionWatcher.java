...
public class ConnectionWatcher implements Watcher {
     ...
     * @param debug
     */
    public ConnectionWatcher(boolean debug, Callback callback) {
        this.debug = debug;
    ...
    public void connect(String hosts) throws IOException, InterruptedException {
        ...
        LOGGER.info("zookeeper: " + hosts + " , 建立连接");
    }
    ...
    public synchronized void reconnect() {
        ...
        while (true) {
            ...
            try {
                ...
                LOGGER.warn("zookeeper失去连接，正在尝试重连");
                ...
                // sleep then retry
                try {
                    int sec = ZookeeperStore.RETRY_PERIOD_SECONDS;
                    LOGGER.warn("休眠： " + sec + "秒");
