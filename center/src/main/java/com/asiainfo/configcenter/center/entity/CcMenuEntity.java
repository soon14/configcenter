 ...
 */
@Entity
@Table(name = "cc_menu", schema = "config_center", catalog = "")
public class CcMenuEntity {
    private int id;
    ...
    @Basic
    @Column(name = "menu_link", nullable = true, length = 255)
    ...
    @Basic
    @Column(name = "menu_icon", nullable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        CcMenuEntity that = (CcMenuEntity) o;
        ...
        if (menuLink != null ? !menuLink.equals(that.menuLink) : that.menuLink != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) menuLevel;
