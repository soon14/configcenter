 ...
 */
@Entity
@Table(name = "cc_app_env", schema = "config_center", catalog = "")
public class CcAppEnvEntity {
    private int id;
    private int appId;
    ...
    @Basic
    @Column(name = "env_name", nullable = false, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        CcAppEnvEntity that = (CcAppEnvEntity) o;
